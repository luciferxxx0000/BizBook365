...
public class GenerativeFormsController {
    ...
    @PostMapping("/create")
    public String saveGenerativeForm(
            @ModelAttribute GenarativeForms genarativeForms,
            Model model,
            @RequestParam("GenerateitemId[]") List<Long> selectedItemIds,
